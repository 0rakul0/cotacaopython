...
class calculadora_cotacao():
    ...
    def abaixo_de(self, min=None, max=None, rendimento=None, limit_liquidez=None, mes=None, calc=None):
        ...
        resultado = []
        result = self.fund_cotas(soup_fundo1, valor_min=min, valor_max=max, rendimento=rendimento, limit_liquidez=limit_liquidez, mes=mes, calc=calc)
        for x in result:
            if x != None:
                resultado.append(x)
        result = resultado
    ...
    def executor(self, acao, valor_min=None, valor_max=None, rendimento=None, limit_liquidez=None, mes=None, calc=None):
        dt = datamine()
    ...
    def fund_cotas(self, soup, valor_min=None, valor_max=None, rendimento=None, limit_liquidez=None, mes=None, calc=None):
        # lista de cotações
        lista_cotas = []
        # nome da cota
        ...
        execucao = Parallel(n_jobs=-1)(
            delayed(self.executor)(acao=acao, valor_min=valor_min, valor_max=valor_max, rendimento=rendimento, limit_liquidez=limit_liquidez, mes=mes, calc=calc) for acao
            in lista_cotas)
        return execucao
